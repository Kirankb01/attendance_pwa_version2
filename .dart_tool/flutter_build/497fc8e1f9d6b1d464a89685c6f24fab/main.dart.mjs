...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1305: (x0,x1,x2) => x0.getCurrentPosition(x1,x2),
      _1306: x0 => ({facingMode: x0}),
      _1307: (x0,x1) => ({video: x0,audio: x1}),
      _1308: (x0,x1) => x0.getUserMedia(x1),
      _1309: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1310: x0 => x0.play(),
      _1311: (x0,x1) => x0.getContext(x1),
      _1312: (x0,x1,x2) => x0.translate(x1,x2),
      _1313: (x0,x1,x2) => x0.scale(x1,x2),
      _1314: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1315: (x0,x1,x2) => x0.toDataURL(x1,x2),
      _1316: x0 => x0.getTracks(),
      _1317: x0 => x0.stop(),
