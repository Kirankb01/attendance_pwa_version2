...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1303: x0 => ({facingMode: x0}),
      _1304: (x0,x1) => ({video: x0,audio: x1}),
      _1305: (x0,x1) => x0.getUserMedia(x1),
      _1306: (x0,x1,x2) => x0.setAttribute(x1,x2),
      _1307: x0 => x0.play(),
      _1308: (x0,x1) => x0.getContext(x1),
      _1309: (x0,x1,x2) => x0.translate(x1,x2),
      _1310: (x0,x1,x2) => x0.scale(x1,x2),
      _1311: (x0,x1,x2,x3) => x0.drawImage(x1,x2,x3),
      _1312: (x0,x1,x2) => x0.toDataURL(x1,x2),
      _1313: x0 => x0.getTracks(),
      _1314: x0 => x0.stop(),
      _1316: () => globalThis.getFaceApiStatus(),
      _1317: x0 => globalThis.generateFaceEmbedding(x0),
      _1318: (x0,x1) => globalThis.compareEmbeddings(x0,x1),
      _1319: Date.now,
      ...
      _1449: () => globalThis.performance,
      _1450: () => globalThis.JSON,
      _1451: x0 => x0.measure,
      _1452: x0 => x0.mark,
      _1453: x0 => x0.clearMeasures,
      _1454: x0 => x0.clearMarks,
      _1455: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1456: (x0,x1,x2) => x0.mark(x1,x2),
      _1457: x0 => x0.clearMeasures(),
      _1458: x0 => x0.clearMarks(),
      _1459: (x0,x1) => x0.parse(x1),
      _1460: (ms, c) =>
      ...
      _1526: (o, p) => p in o,
      _1527: (o, p) => o[p],
      _1536: (x0,x1) => x0.createElement(x1),
      _1540: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1540(f,arguments.length,x0) }),
      _1541: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1542: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1548: () => new AbortController(),
      _1549: x0 => x0.abort(),
      _1550: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1551: (x0,x1) => globalThis.fetch(x0,x1),
      _1552: (x0,x1) => x0.get(x1),
      _1553: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1553(f,arguments.length,x0,x1,x2) }),
      _1554: (x0,x1) => x0.forEach(x1),
      _1555: x0 => x0.getReader(),
      _1556: x0 => x0.cancel(),
      _1557: x0 => x0.read(),
      _1558: (x0,x1) => x0.key(x1),
      ...
      _1817: x0 => x0.style,
      _2389: x0 => x0.videoWidth,
      _2390: x0 => x0.videoHeight,
      _2426: (x0,x1) => { x0.srcObject = x1 },
      _2450: (x0,x1) => { x0.autoplay = x1 },
      _2458: (x0,x1) => { x0.muted = x1 },
      _3098: x0 => x0.width,
      _3099: (x0,x1) => { x0.width = x1 },
      _3101: (x0,x1) => { x0.height = x1 },
